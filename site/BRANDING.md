...
The document head maps favicon assets with media queries. The navbar mark uses a picture element in site/src/components/LogoMark.astro with matching media-specific sources.
