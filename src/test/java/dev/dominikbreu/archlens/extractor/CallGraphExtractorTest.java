...
class CallGraphExtractorTest extends ExtractorTestBase {
    ...
    void genericObjectFlowRecordsAccessorBasedStateReadsAndWrites() {
        ...
        assertThat(generic.fieldAccesses).anySatisfy(access -> {
            ...
            assertThat(access.fieldBinding)
                    .isInstanceOf(dev.dominikbreu.archlens.model.ids.FieldBinding.CrossComponent.class);
            assertThat(((dev.dominikbreu.archlens.model.ids.FieldBinding.CrossComponent) access.fieldBinding)
                            .ref()
                            .owner()
                            .serialize())
    ...
    void accessorReturnChainDoesNotResolveJdkReturnTypeToProjectEqualsMethod() {
        ...
        new CallGraphExtractor(new dev.dominikbreu.archlens.extractor.objectflow.ObjectFlowIndexBuilder()
