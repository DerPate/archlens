...
class MermaidDependencyMapRendererTest {
    ...
    void aggregatesDependenciesBySourceResponsibility() {
        ...
        Component extractor = component(
                "extractor", "ArchitectureExtractor", "dev.dominikbreu.archlens.extractor.ArchitectureExtractor");
        Component scanner = component("scanner", "SpoonScanner", "dev.dominikbreu.archlens.scanner.SpoonScanner");
    ...
    void countsInternalDependenciesWithoutDrawingSelfEdges() {
        ...
        Component extractor = component(
                "extractor", "ArchitectureExtractor", "dev.dominikbreu.archlens.extractor.ArchitectureExtractor");
        Component condenser =
                component("condenser", "DependencyCondenser", "dev.dominikbreu.archlens.extractor.DependencyCondenser");
