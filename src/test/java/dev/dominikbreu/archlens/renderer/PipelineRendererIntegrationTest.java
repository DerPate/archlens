...
class PipelineRendererIntegrationTest {
    ...
    void rendererAndBuilderHardcodeNoFixtureNames() throws Exception {
        ...
        java.nio.file.Path renderer =
                java.nio.file.Paths.get("src/main/java/dev/dominikbreu/archlens/renderer/MermaidPipelineRenderer.java");
        java.nio.file.Path builder =
                java.nio.file.Paths.get("src/main/java/dev/dominikbreu/archlens/extractor/PipelineGraphBuilder.java");
