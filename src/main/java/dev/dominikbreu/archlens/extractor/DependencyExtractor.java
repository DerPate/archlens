...
public class DependencyExtractor {
    ...
    public void extract(CtModel ctModel, ArchitectureModel model) {
        Map<ComponentId, dev.dominikbreu.archlens.model.Component> componentsById = new HashMap<>();
    ...
    private Map<String, List<ComponentId>> buildImplementorIndex(
            CtModel ctModel, Map<ComponentId, dev.dominikbreu.archlens.model.Component> componentsById) {
    ...
    private void extractTypeRefDeps(
            ...
            Map<ComponentId, dev.dominikbreu.archlens.model.Component> componentsById,
            ComponentId fromId,
    ...
    private void addDep(
        ...
        dev.dominikbreu.archlens.model.ids.DependencyId id =
                dev.dominikbreu.archlens.model.ids.DependencyId.of(from, to);
    ...
    private void dedup(ArchitectureModel model) {
        Map<dev.dominikbreu.archlens.model.ids.DependencyId, Dependency> byId = new LinkedHashMap<>();
