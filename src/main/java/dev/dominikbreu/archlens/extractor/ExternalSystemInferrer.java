...
public class ExternalSystemInferrer {
    ...
    public void infer(ArchitectureModel model) {
        ...
        Set<dev.dominikbreu.archlens.model.ids.DependencyId> existingDeps = new LinkedHashSet<>();
    ...
    private void inferRestClientSystems(
            ...
            Set<dev.dominikbreu.archlens.model.ids.DependencyId> existingDeps) {
    ...
    private void addDependency(
            ArchitectureModel model,
            Set<dev.dominikbreu.archlens.model.ids.DependencyId> existing,
            String fromId,
            String toId,
            String kind) {
        if (fromId == null || toId == null) return;
        Dependency d = new Dependency();
        d.fromId = dev.dominikbreu.archlens.model.ids.ComponentId.of(fromId);
        d.toId = dev.dominikbreu.archlens.model.ids.ComponentId.of(toId);
        d.id = dev.dominikbreu.archlens.model.ids.DependencyId.of(d.fromId, d.toId, kind);
