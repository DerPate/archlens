...
public class ExportGraphArchitecturePocTool {
    ...
    private String renderMarkdown(GraphQuery graph, String focusComponent) {
        ...
        sb.append(JSON_FENCE_OPEN);
        sb.append(
                "{\"action\":\"find_nodes\",\"label\":\"Component\",\"filters\":{\"packageName\":\"dev.dominikbreu.archlens.cache\"}}\n");
        sb.append(JSON_FENCE_CLOSE);
        sb.append(JSON_FENCE_OPEN);
        sb.append(
        ...
        sb.append(JSON_FENCE_OPEN);
        sb.append(
                "{\"action\":\"impacted_by\",\"nodeId\":\"dev.dominikbreu.archlens.cache.ArchitectureGraph\",\"maxDepth\":4}\n");
        sb.append("```\n");
